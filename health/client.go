...
func (c *Client) Readiness(ctx context.Context, tags []string, options ...rpc.Option) (*apihealth.APIReply, error) {
	res := &apihealth.APIReply{}
	err := c.Requester.SendRequest(ctx, "health.readiness", &apihealth.APIArgs{Tags: tags}, res, options...)
	return res, err
}
...
func (c *Client) Health(ctx context.Context, tags []string, options ...rpc.Option) (*apihealth.APIReply, error) {
	res := &apihealth.APIReply{}
	err := c.Requester.SendRequest(ctx, "health.health", &apihealth.APIArgs{Tags: tags}, res, options...)
	return res, err
}
...
func (c *Client) Liveness(ctx context.Context, tags []string, options ...rpc.Option) (*apihealth.APIReply, error) {
	res := &apihealth.APIReply{}
	err := c.Requester.SendRequest(ctx, "health.liveness", &apihealth.APIArgs{Tags: tags}, res, options...)
	return res, err
}
...
func await(
	ctx context.Context,
	freq time.Duration,
	check func(ctx context.Context, tags []string, options ...rpc.Option) (*apihealth.APIReply, error),
	tags []string,
	options ...rpc.Option,
) (bool, error) {
