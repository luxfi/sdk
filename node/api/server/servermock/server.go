...
// Source: github.com/luxfi/sdk/node/api/server (interfaces: Server)
//
// Generated by this command:
//
//	mockgen -package=servermock -destination=api/server/servermock/server.go -mock_names=Server=Server github.com/luxfi/sdk/node/api/server Server
//
...
func (m *Server) RegisterChain(arg0 string, arg1 *consensuscontext.Context, arg2 consensuscore.VM) {
	m.ctrl.T.Helper()
