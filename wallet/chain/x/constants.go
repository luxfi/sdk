...
// Wave 1A rip (#101); construction is delegated to proto/zap_codec —
// the single canonical site where the wire codec backend is chosen.
//
...
func init() {
	var err error
	Parser, err = block.NewParser(newXVMParserCodecs(), []fxs.Fx{
		&secp256k1fx.Fx{},
		&nftfx.Fx{},
		&propertyfx.Fx{},
	})
