...
func GetRegisterL1ValidatorMessage(
	...
	if registerSubnetValidatorUnsignedMessage == nil {
		...
		if !ok {
			return nil, ids.Empty, fmt.Errorf("payload is not an addressed call")
		}
	...
	signedMessage, err := warpMessage.ConvertStandaloneToNodeWarpMessage(standaloneSignedMessage)
	if err != nil {
