...
const (
	// LUXCoinType is the BIP-44 coin type for LUX P/X-Chain (9000')
	LUXCoinType = 9000

	// EthCoinType is the BIP-44 coin type for C-Chain/EVM (60')
	EthCoinType = 60

	// DefaultDerivationPath is the standard BIP-44 path for LUX P/X-Chain: m/44'/9000'/0'/0/0
...
func DeriveKeyFromSeed(seed []byte, accountIndex uint32) ([]byte, error) {
	...
	// BIP-44 path: m/44'/9000'/0'/0/{accountIndex} (Lux P/X-Chain)
	// m/44' (purpose)
	...
	// m/44'/9000' (coin type - Lux P/X-Chain)
