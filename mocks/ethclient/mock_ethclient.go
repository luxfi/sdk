...
// Source: /home/z/work/lux/evm/ethclient/ethclient.go
//
// Generated by this command:
//
//	mockgen -source=/home/z/work/lux/evm/ethclient/ethclient.go -destination=mocks/ethclient/mock_ethclient.go -package=mock_ethclient Client
//
...
func (m *MockClient) SubscribeTransactionReceipts(arg0 context.Context, arg1 *ethereum.TransactionReceiptsQuery, arg2 chan<- []*types.Receipt) (ethereum.Subscription, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SubscribeTransactionReceipts", arg0, arg1, arg2)
	ret0, _ := ret[0].(ethereum.Subscription)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockClientMockRecorder) SubscribeTransactionReceipts(arg0, arg1, arg2 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SubscribeTransactionReceipts", reflect.TypeOf((*MockClient)(nil).SubscribeTransactionReceipts), arg0, arg1, arg2)
}
...
// MockBlockHook is a mock of BlockHook interface.
type MockBlockHook struct {
	ctrl     *gomock.Controller
	recorder *MockBlockHookMockRecorder
	isgomock struct{}
}

// MockBlockHookMockRecorder is the mock recorder for MockBlockHook.
type MockBlockHookMockRecorder struct {
	mock *MockBlockHook
}

// NewMockBlockHook creates a new mock instance.
func NewMockBlockHook(ctrl *gomock.Controller) *MockBlockHook {
	mock := &MockBlockHook{ctrl: ctrl}
	mock.recorder = &MockBlockHookMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockBlockHook) EXPECT() *MockBlockHookMockRecorder {
	return m.recorder
}

// OnBlockDecoded mocks base method.
func (m *MockBlockHook) OnBlockDecoded(raw json.RawMessage, block *types.Block) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "OnBlockDecoded", raw, block)
	ret0, _ := ret[0].(error)
	return ret0
}

// OnBlockDecoded indicates an expected call of OnBlockDecoded.
func (mr *MockBlockHookMockRecorder) OnBlockDecoded(raw, block any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "OnBlockDecoded", reflect.TypeOf((*MockBlockHook)(nil).OnBlockDecoded), raw, block)
}
